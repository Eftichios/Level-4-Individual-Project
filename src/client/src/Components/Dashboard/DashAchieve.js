...
export class DashAchieve extends React.Component {
    ...
    render(){
        ...
        <div className="table-responsive achieve-scrollbar">
            ...
            <div class="modal fade" id="achievementModal" tabindex="-1" role="dialog" aria-labelledby="achievementLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="achievementLabel">{this.state.modalContent.title}</h5>
